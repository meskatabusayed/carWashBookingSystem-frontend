...
//     const newStatus = slotToUpdate.isBooked ? "available" : "canceled"; 
//     try {
//       const updateData = {
//         id: slotToUpdate._id,
//         isBooked: newStatus,
...
//           onChange={(value) => toggleStatus(record.key) }
//           style={{ width: 120 }}
//           disabled={isBooked} // Disable the select when the status is "booked"
//         >
//           <Option value="available" disabled={isBooked}>AVAILABLE</Option>
//           <Option value="booked" disabled={isBooked}>BOOKED</Option>
//           <Option value="canceled" disabled={isBooked}>canceled</Option>
//         </Select>
//       ),
//     },
//     {
